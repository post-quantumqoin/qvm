    ...
    K: Kernel,
{
    ...
    fn execute_message(
        ...
        println!("execute_message msg.from {}",msg.from.to_string());
        println!("execute_message msg.to {}",msg.to.to_string());
        println!("execute_message msg.method_num {}",msg.method_num);
        println!("execute_message preflight_message");
        ...
        let ret = self.map_machine(|machine| {
            ...
            println!("execute_message map_machine");
            ...
            println!("execute_message charge_gas");
            ...
            println!("execute_message with_transaction");
