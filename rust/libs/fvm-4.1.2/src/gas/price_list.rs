    ...
    static ref WATERMELON_PRICES: PriceList = PriceList {
        ...
        sig_cost: total_enum_map!{
            SignatureType {
                ...
                MultiPqc=>  ScalingCost{
                    flat: Gas::new(16598605),
                    scale: Gas::new(1),
                },
                Falcon512=>  ScalingCost{
                    flat: Gas::new(16598605),
                    scale: Gas::new(1),
                },
                Falcon1024=>  ScalingCost{
                    flat: Gas::new(16598605),
                    scale: Gas::new(1),
                },
                Dilithium3=>  ScalingCost{
                    flat: Gas::new(16598605),
                    scale: Gas::new(1),
                },
                Dilithium5=>  ScalingCost{
                    flat: Gas::new(16598605),
                    scale: Gas::new(1),
                },
...
impl PriceList {
    ...
    pub fn on_verify_signature(&self, sig_type: SignatureType, data_len: usize) -> GasCharge {
        ...
        println!("on_verify_signature cost sig_type:{}, gas:{}",sig_type as u8,gas);
